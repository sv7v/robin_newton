...
# TO DO Забыт Кельвин в условии задачи.
			...
			alpha1,         # α₁
			alpha2,         # α₂
			temp1,          # T₁  температура на внутренней стенки трубы
			temp2):         # T₂
	...
	def dtemp(s, i,         # i-я ячейка
	             P_prev,    # мощность ПОЛучаемая   от предыдущей ячейки
	             P_next):   # ---//--- ПЕРЕдаваемая     следующей
		'''Изменение температуры ячейки.'''
		# расстояние между центрами крайних ячеек
		a = (s.rad2-s.rad1)*(s.n-1/s.n)
		# Отношение радиусов крайних ячеек. Оно же равно отношению объёмов крайних ячеек.
		b = (s.rad2+a)/s.rad1
